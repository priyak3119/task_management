                    ...
                    <div class="p-6 text-white">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                ...
                                <blockquote class="text-lg italic mb-2" v-if="quote.content">
                                    "{{ quote.content }}"
                                </blockquote>
                                <p class="text-sm opacity-90" v-if="quote.author">
                                    — {{ quote.author }}
                                </p>
                                <p v-if="quoteError" class="text-red-200 text-sm">
                                    {{ quoteError }}
                                </p>
                            </div>
                            <button
                                ...
                                class="ml-4 bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition-colors duration-200 disabled:opacity-50"
                            >
                                <svg v-if="loadingQuote" class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
...
const fetchQuote = async () => {
    ...
    try {
        ...
        quoteError.value = 'Failed to load quote. Please try again.'
        quote.value = {
